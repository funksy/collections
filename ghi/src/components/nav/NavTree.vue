...
<template>
  <div class="nav-tree">
    <div>
      <NavLink class="nav-tree-link" name="Collections" path="/" />
    </div>
    <div v-if="collection.name">
      <NavLink class="nav-tree-link" :name="collection.name" :path="collection.path" />
    </div>
    <div v-if="item.name">
      <NavLink class="nav-tree-link" :name="item.name" :path="item.path" />
    </div>
  </div>
</template>
